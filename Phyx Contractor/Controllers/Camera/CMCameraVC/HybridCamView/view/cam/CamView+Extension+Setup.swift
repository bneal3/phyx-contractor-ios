...
extension CamView{
    ...
    private func setupBackgroundAudioSupport(allowBackgroundAudio:Bool = true) throws{
        do{
            try AVAudioSession.sharedInstance().setCategory(AVAudioSession.Category.playAndRecord, mode: AVAudioSession.Mode.default, options: AVAudioSession.CategoryOptions.allowAirPlay)
